...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1003305341477").split()
]
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002739334108"))
...
PAYPICS = (
    environ.get("PAYPICS", "https://i.ibb.co/XfQMtP6L/photo-2025-07-03-14-04-41-7522856371105038356.jpg")
).split()
